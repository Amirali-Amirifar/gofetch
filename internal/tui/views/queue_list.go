...
func (m queueListModel) Init() tea.Cmd { return nil }
...
func (m queueListModel) View() string {
	...
	return lipgloss.JoinVertical(lipgloss.Center, []string{"Queue List Info", renderedTable}...) + "\n"
}

func InitQueueList() queueListModel {
